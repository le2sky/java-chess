...
- [x] 주어진 좌표가 경로에 포함되어 있는지 확인할 수 있다.
- [x] 주어진 타겟 좌표로 가는 중 방해물이 있는지 확인할 수 있다.
- [x] 시작 위치를 제외한 주어진 방향의 경로를 생성할 수 있다.
- [x] 한 경로에 있는 중복된 피스를 찾을 수 있다.
